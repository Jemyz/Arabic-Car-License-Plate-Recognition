...
import numpy as np
from plate_detection.misc import box_area, read_image
from scipy.misc import imshow
import argparse

PATH_TO_PLATE_OR_NON_PLATE_CLASSIFIER = 'plate_non_plate_classifier/model/retrained_graph.pb'
PATH_TO_PLATE_OR_NON_PLATE_LABELS = "plate_non_plate_classifier/data/retrained_labels.txt"
