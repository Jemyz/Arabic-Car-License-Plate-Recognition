import argparse
import numpy as np
from plate_detection.plate_localization import PlateLocalization
from scipy.misc import imshow
from plate_detection.misc import bound_to_box
from plate_detection.plate_non_plate_classifier import PlateClassifier
from plate_detection.vehicle_detection import VehicleDetection
...
def run(args):
    pd = PlateDetection()
    box, img = pd.get_plate(args.image)
