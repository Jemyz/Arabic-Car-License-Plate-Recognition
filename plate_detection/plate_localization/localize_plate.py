...
from plate_detection.misc import read_image, draw_contours_bounds, bound_to_box
import os
from plate_detection.plate_localization.sobel_method import sobel_edge_method
